...
route::get('/c/{company}/adverts', [CompanyController::class, 'index'])->middleware(['auth:sanctum']);
route::get('/adverts/{id}', [NewAdvertController::class, 'show'])->middleware(['auth:sanctum']);